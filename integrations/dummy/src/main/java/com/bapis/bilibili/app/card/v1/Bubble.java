...
public final class Bubble extends GeneratedMessageLite<Bubble, Bubble.C5795b> implements MessageLiteOrBuilder {
    ...
    /* compiled from: BL */
    /* renamed from: com.bapis.bilibili.app.card.v1.Bubble$a */
    /* loaded from: classes13.dex */
    static /* synthetic */ class C5794a {
        ...
        static {
            ...
            try {
                f15946xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15946xa1df5c61[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15946xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15946xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15946xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15946xa1df5c61[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* compiled from: BL */
    /* renamed from: com.bapis.bilibili.app.card.v1.Bubble$b */
    /* loaded from: classes13.dex */
    public static final class C5795b extends GeneratedMessageLite.Builder<Bubble, C5795b> implements MessageLiteOrBuilder {
        /* synthetic */ C5795b(C5794a c5794a) {
            this();
        }

        public C5795b clearBubbleContent() {
            copyOnWrite();
            ((Bubble) this.instance).clearBubbleContent();
            return this;
        }

        public C5795b clearStime() {
            copyOnWrite();
            ((Bubble) this.instance).clearStime();
            return this;
        }

        public C5795b clearVersion() {
            copyOnWrite();
        ...
        public C5795b setBubbleContent(String str) {
            copyOnWrite();
            ((Bubble) this.instance).setBubbleContent(str);
            return this;
        }

        public C5795b setBubbleContentBytes(ByteString byteString) {
            copyOnWrite();
            ((Bubble) this.instance).setBubbleContentBytes(byteString);
            return this;
        }

        public C5795b setStime(long j) {
            copyOnWrite();
            ((Bubble) this.instance).setStime(j);
            return this;
        }

        public C5795b setVersion(int i) {
            copyOnWrite();
    ...
    public static C5795b newBuilder() {
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C5794a.f15946xa1df5c61[methodToInvoke.ordinal()]) {
            case 1:
                return new Bubble();
            case 2:
                return new C5795b(null);
            case 3:
    ...
    public static C5795b newBuilder(Bubble bubble) {
