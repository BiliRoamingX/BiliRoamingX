...
public final class Interaction extends GeneratedMessageLite<Interaction, Interaction.Builder> implements MessageLiteOrBuilder {
    ...
    /* compiled from: BL */
    /* renamed from: com.bapis.bilibili.playershared.Interaction$1 */
    /* loaded from: classes18.dex */
    static /* synthetic */ class C82061 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f17937xa1df5c61;

        static {
            int[] iArr = new int[GeneratedMessageLite.MethodToInvoke.values().length];
            f17937xa1df5c61 = iArr;
            try {
                iArr[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f17937xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f17937xa1df5c61[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f17937xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f17937xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f17937xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f17937xa1df5c61[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Interaction, Builder> implements MessageLiteOrBuilder {
        /* synthetic */ Builder(C82061 c82061) {
            this();
        }
    ...
    public void mergeHistoryNode(Node node) {
        ...
        if (node2 != null && node2 != Node.getDefaultInstance()) {
            this.historyNode_ = Node.newBuilder(this.historyNode_).mergeFrom((Node) node).buildPartial();
        } else {
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C82061.f17937xa1df5c61[methodToInvoke.ordinal()]) {
            case 1:
                return new Interaction();
            case 2:
                return new Builder(null);
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0004\u0000\u0000\u0001\u0004\u0004\u0000\u0000\u0000\u0001\t\u0002\u0002\u0003\u0208\u0004\u0002", new Object[]{"historyNode_", "graphVersion_", "msg_", "mark_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
