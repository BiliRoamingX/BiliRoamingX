...
public final class Interaction extends GeneratedMessageLite<Interaction, Interaction.Builder> implements MessageLiteOrBuilder {
    ...
    /* compiled from: BL */
    /* renamed from: com.bapis.bilibili.app.viewunite.common.Interaction$1 */
    /* loaded from: classes17.dex */
    static /* synthetic */ class C70041 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f16988xa1df5c61;

        static {
            int[] iArr = new int[GeneratedMessageLite.MethodToInvoke.values().length];
            f16988xa1df5c61 = iArr;
            try {
                iArr[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f16988xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f16988xa1df5c61[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f16988xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f16988xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f16988xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f16988xa1df5c61[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Interaction, Builder> implements MessageLiteOrBuilder {
        /* synthetic */ Builder(C70041 c70041) {
            this();
        }

        public Builder clearEpId() {
            copyOnWrite();
            ((Interaction) this.instance).clearEpId();
            return this;
        }
        ...
        public long getEpId() {
            return ((Interaction) this.instance).getEpId();
        }
        ...
        public Builder setEpId(long j) {
            copyOnWrite();
            ((Interaction) this.instance).setEpId(j);
            return this;
        }
    ...
    public void mergeHistoryNode(HistoryNode historyNode) {
        ...
        HistoryNode historyNode2 = this.historyNode_;
        if (historyNode2 != null && historyNode2 != HistoryNode.getDefaultInstance()) {
            this.historyNode_ = HistoryNode.newBuilder(this.historyNode_).mergeFrom((HistoryNode) historyNode).buildPartial();
        } else {
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C70041.f16988xa1df5c61[methodToInvoke.ordinal()]) {
            case 1:
                return new Interaction();
            case 2:
                return new Builder(null);
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0005\u0000\u0000\u0001\u0005\u0005\u0000\u0000\u0000\u0001\u0002\u0002\t\u0003\u0002\u0004\u0208\u0005\u0007", new Object[]{"epId_", "historyNode_", "graphVersion_", "msg_", "isInteraction_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
