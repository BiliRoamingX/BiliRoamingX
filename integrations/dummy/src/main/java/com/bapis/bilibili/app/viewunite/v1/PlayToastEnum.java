...
public enum PlayToastEnum implements Internal.EnumLite {
    ...
    private static final Internal.EnumLiteMap<PlayToastEnum> internalValueMap = new Internal.EnumLiteMap<PlayToastEnum>() { // from class: com.bapis.bilibili.app.viewunite.v1.PlayToastEnum.1
