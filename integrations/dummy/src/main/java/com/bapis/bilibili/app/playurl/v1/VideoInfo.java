...
public final class VideoInfo extends GeneratedMessageLite<VideoInfo, VideoInfo.Builder> implements MessageLiteOrBuilder {
    ...
    /* compiled from: BL */
    /* renamed from: com.bapis.bilibili.app.playurl.v1.VideoInfo$1 */
    /* loaded from: classes13.dex */
    static /* synthetic */ class C65231 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f16553xa1df5c61;

        static {
            int[] iArr = new int[GeneratedMessageLite.MethodToInvoke.values().length];
            f16553xa1df5c61 = iArr;
            try {
                iArr[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f16553xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f16553xa1df5c61[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f16553xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f16553xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f16553xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f16553xa1df5c61[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<VideoInfo, Builder> implements MessageLiteOrBuilder {
        /* synthetic */ Builder(C65231 c65231) {
            this();
        }
        ...
        public Builder clearLossLessItem() {
            copyOnWrite();
            ((VideoInfo) this.instance).clearLossLessItem();
            return this;
        }
        ...
        public Builder clearVolume() {
            copyOnWrite();
            ((VideoInfo) this.instance).clearVolume();
            return this;
        }
        ...
        public LossLessItem getLossLessItem() {
            return ((VideoInfo) this.instance).getLossLessItem();
        }
        ...
        public VolumeInfo getVolume() {
            return ((VideoInfo) this.instance).getVolume();
        }
        ...
        public boolean hasLossLessItem() {
            return ((VideoInfo) this.instance).hasLossLessItem();
        }

        public boolean hasVolume() {
            return ((VideoInfo) this.instance).hasVolume();
        }
        ...
        public Builder mergeLossLessItem(LossLessItem lossLessItem) {
            copyOnWrite();
            ((VideoInfo) this.instance).mergeLossLessItem(lossLessItem);
            return this;
        }

        public Builder mergeVolume(VolumeInfo volumeInfo) {
            copyOnWrite();
            ((VideoInfo) this.instance).mergeVolume(volumeInfo);
            return this;
        }
        ...
        public Builder setLossLessItem(LossLessItem lossLessItem) {
            copyOnWrite();
            ((VideoInfo) this.instance).setLossLessItem(lossLessItem);
            return this;
        }
        ...
        public Builder setVolume(VolumeInfo volumeInfo) {
            copyOnWrite();
            ((VideoInfo) this.instance).setVolume(volumeInfo);
            return this;
        }
        ...
        public Builder setLossLessItem(LossLessItem.Builder builder) {
            copyOnWrite();
            ((VideoInfo) this.instance).setLossLessItem(builder.build());
            return this;
        }
        ...
        public Builder setVolume(VolumeInfo.Builder builder) {
            copyOnWrite();
            ((VideoInfo) this.instance).setVolume(builder.build());
            return this;
        }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C65231.f16553xa1df5c61[methodToInvoke.ordinal()]) {
            case 1:
                return new VideoInfo();
            case 2:
                return new Builder(null);
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\t\u0000\u0000\u0001\t\t\u0000\u0002\u0000\u0001\u000b\u0002\u0208\u0003\u0003\u0004\u000b\u0005\u001b\u0006\u001b\u0007\t\b\t\t\t", new Object[]{"quality_", "format_", "timelength_", "videoCodecid_", "streamList_", Stream.class, "dashAudio_", DashItem.class, "dolby_", "volume_", "lossLessItem_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
    ...
    public VolumeInfo getVolume() {
        VolumeInfo volumeInfo = this.volume_;
