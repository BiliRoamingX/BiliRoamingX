...
public enum CodeType implements Internal.EnumLite {
    ...
    private static final Internal.EnumLiteMap<CodeType> internalValueMap = new Internal.EnumLiteMap<CodeType>() { // from class: com.bapis.bilibili.playershared.CodeType.1
