...
class CrossProcessPreferences(private val name: String) : SharedPreferences {
    ...
    private inner class EditorImpl(private val delegate: SharedPreferences.Editor) : SharedPreferences.Editor {
        ...
        override fun commit(): Boolean {
            return if (Utils.isMainProcess()) {
                ...
                PreferenceUpdater.update(name, clear, true, ArrayList(editOps.values))
                true
            }
        }
        ...
        override fun apply() {
            if (Utils.isMainProcess()) {
                ...
                PreferenceUpdater.update(name, clear, false, ArrayList(editOps.values))
            }
        }
    }
}
