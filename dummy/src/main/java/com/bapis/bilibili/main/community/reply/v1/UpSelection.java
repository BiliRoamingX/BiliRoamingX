...
public final class UpSelection extends GeneratedMessageLite<UpSelection, UpSelection.C14889b> implements MessageLiteOrBuilder {
    ...
    /* compiled from: BL */
    /* renamed from: com.bapis.bilibili.main.community.reply.v1.UpSelection$a */
    /* loaded from: classes21.dex */
    static /* synthetic */ class C14888a {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f22047xa1df5c61;

        static {
            int[] iArr = new int[GeneratedMessageLite.MethodToInvoke.values().length];
            f22047xa1df5c61 = iArr;
            try {
                iArr[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f22047xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f22047xa1df5c61[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f22047xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f22047xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f22047xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f22047xa1df5c61[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* compiled from: BL */
    /* renamed from: com.bapis.bilibili.main.community.reply.v1.UpSelection$b */
    /* loaded from: classes21.dex */
    public static final class C14889b extends GeneratedMessageLite.Builder<UpSelection, C14889b> implements MessageLiteOrBuilder {
        /* synthetic */ C14889b(C14888a c14888a) {
            this();
        }

        public C14889b clearIgnoreCount() {
            copyOnWrite();
            ((UpSelection) this.instance).clearIgnoreCount();
            return this;
        }

        public C14889b clearPendingCount() {
            copyOnWrite();
        ...
        public C14889b setIgnoreCount(long j) {
            copyOnWrite();
            ((UpSelection) this.instance).setIgnoreCount(j);
            return this;
        }

        public C14889b setPendingCount(long j) {
            copyOnWrite();
    ...
    public static C14889b newBuilder() {
        return DEFAULT_INSTANCE.createBuilder();
    }

    public static UpSelection parseDelimitedFrom(InputStream inputStream) throws IOException {
        return (UpSelection) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C14888a.f22047xa1df5c61[methodToInvoke.ordinal()]) {
            case 1:
                return new UpSelection();
            case 2:
                return new C14889b(null);
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001\u0002\u0002\u0002", new Object[]{"pendingCount_", "ignoreCount_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
    ...
    public static C14889b newBuilder(UpSelection upSelection) {
    ...
    public static UpSelection parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        return (UpSelection) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }
