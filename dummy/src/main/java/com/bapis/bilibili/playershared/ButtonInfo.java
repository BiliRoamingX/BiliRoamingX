...
public final class ButtonInfo extends GeneratedMessageLite<ButtonInfo, ButtonInfo.Builder> implements ButtonInfoOrBuilder {
    ...
    public static final int FRAME_COLOR_FIELD_NUMBER = 17;
    ...
    /* compiled from: BL */
    /* renamed from: com.bapis.bilibili.playershared.ButtonInfo$1 */
    /* loaded from: classes18.dex */
    static /* synthetic */ class C81621 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f17890xa1df5c61;

        static {
            int[] iArr = new int[GeneratedMessageLite.MethodToInvoke.values().length];
            f17890xa1df5c61 = iArr;
            try {
                iArr[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f17890xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f17890xa1df5c61[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f17890xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f17890xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f17890xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f17890xa1df5c61[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* compiled from: BL */
    /* loaded from: classes18.dex */
    public static final class Builder extends GeneratedMessageLite.Builder<ButtonInfo, ButtonInfo.Builder> implements ButtonInfoOrBuilder {
        /* synthetic */ Builder(C81621 c81621) {
            this();
        }
        ...
        public Builder clearFrameColor() {
            copyOnWrite();
            ((ButtonInfo) this.instance).clearFrameColor();
            return this;
        }

        public Builder clearIcon() {
            copyOnWrite();
            ((ButtonInfo) this.instance).clearIcon();
            return this;
        }
        ...
        @Override // com.bapis.bilibili.playershared.ButtonInfoOrBuilder
        ...
        public int getActionTypeValue() {
            return ((ButtonInfo) this.instance).getActionTypeValue();
        }
        ...
        public String getFrameColor() {
            return ((ButtonInfo) this.instance).getFrameColor();
        }

        @Override // com.bapis.bilibili.playershared.ButtonInfoOrBuilder
        public ByteString getFrameColorBytes() {
            return ((ButtonInfo) this.instance).getFrameColorBytes();
        }

        @Override // com.bapis.bilibili.playershared.ButtonInfoOrBuilder
        public String getIcon() {
            return ((ButtonInfo) this.instance).getIcon();
        }

        @Override // com.bapis.bilibili.playershared.ButtonInfoOrBuilder
        public ByteString getIconBytes() {
            return ((ButtonInfo) this.instance).getIconBytes();
        }
        ...
        public Builder setActionType(ButtonAction buttonAction) {
            copyOnWrite();
            ((ButtonInfo) this.instance).setActionType(buttonAction);
            return this;
        }

        public Builder setActionTypeValue(int i) {
            copyOnWrite();
            ((ButtonInfo) this.instance).setActionTypeValue(i);
            return this;
        }
        ...
        public Builder setFrameColor(String str) {
            copyOnWrite();
            ((ButtonInfo) this.instance).setFrameColor(str);
            return this;
        }

        public Builder setFrameColorBytes(ByteString byteString) {
            copyOnWrite();
            ((ButtonInfo) this.instance).setFrameColorBytes(byteString);
            return this;
        }

        public Builder setIcon(String str) {
            copyOnWrite();
            ((ButtonInfo) this.instance).setIcon(str);
            return this;
        }

        public Builder setIconBytes(ByteString byteString) {
            copyOnWrite();
            ((ButtonInfo) this.instance).setIconBytes(byteString);
            return this;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void clearFrameColor() {
        this.frameColor_ = getDefaultInstance().getFrameColor();
    }
    ...
    public void mergeSimpleTextInfo(TextInfo textInfo) {
        ...
        if (textInfo2 != null && textInfo2 != TextInfo.getDefaultInstance()) {
            this.simpleTextInfo_ = TextInfo.newBuilder(this.simpleTextInfo_).mergeFrom((TextInfo) textInfo).buildPartial();
        } else {
    ...
    public void mergeTaskParam(TaskParam taskParam) {
        taskParam.getClass();
        TaskParam taskParam2 = this.taskParam_;
        if (taskParam2 != null && taskParam2 != TaskParam.getDefaultInstance()) {
            this.taskParam_ = TaskParam.newBuilder(this.taskParam_).mergeFrom((TaskParam) taskParam).buildPartial();
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setActionType(ButtonAction buttonAction) {
        this.actionType_ = buttonAction.getNumber();
    }
    ...
    public void setFrameColor(String str) {
        str.getClass();
        this.frameColor_ = str;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void setFrameColorBytes(ByteString byteString) {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
        this.frameColor_ = byteString.toStringUtf8();
    }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (C81621.f17890xa1df5c61[methodToInvoke.ordinal()]) {
            case 1:
                return new ButtonInfo();
            case 2:
                return new Builder(null);
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0012\u0000\u0000\u0001\u0012\u0012\u0001\u0000\u0000\u0001\u0208\u0002\u0208\u0003\u0208\u0004\u0208\u0005\u0208\u0006\u0208\u0007\f\b\t\t\t\n\u0208\u000b\t\f\u0208\r\u0208\u000e\t\u000f2\u0010\t\u0011\u0208\u0012\u0208", new Object[]{"text_", "textColor_", "textColorNight_", "bgColor_", "bgColorNight_", "link_", "actionType_", "badgeInfo_", "report_", "leftStrikethroughText_", "simpleTextInfo_", "simpleBgColor_", "simpleBgColorNight_", "bgGradientColor_", "orderReportParams_", OrderReportParamsDefaultEntryHolder.defaultEntry, "taskParam_", "frameColor_", "icon_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
    ...
    @Override // com.bapis.bilibili.playershared.ButtonInfoOrBuilder
    public ButtonAction getActionType() {
        ButtonAction forNumber = ButtonAction.forNumber(this.actionType_);
    ...
    @Override // com.bapis.bilibili.playershared.ButtonInfoOrBuilder
    public ByteString getFrameColorBytes() {
        return ByteString.copyFromUtf8(this.frameColor_);
    }
