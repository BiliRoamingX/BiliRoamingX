...
public enum LimitActionType implements Internal.EnumLite {
    ...
    private static final Internal.EnumLiteMap<LimitActionType> internalValueMap = new Internal.EnumLiteMap<LimitActionType>() { // from class: com.bapis.bilibili.playershared.LimitActionType.1
