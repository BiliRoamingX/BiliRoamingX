...
public enum DescType implements Internal.EnumLite {
    ...
    private static final Internal.EnumLiteMap<DescType> internalValueMap = new Internal.EnumLiteMap<DescType>() { // from class: com.bapis.bilibili.app.view.v1.DescType.1
