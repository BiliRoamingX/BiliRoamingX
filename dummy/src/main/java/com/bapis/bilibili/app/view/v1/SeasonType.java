...
public enum SeasonType implements Internal.EnumLite {
    ...
    private static final Internal.EnumLiteMap<SeasonType> internalValueMap = new Internal.EnumLiteMap<SeasonType>() { // from class: com.bapis.bilibili.app.view.v1.SeasonType.1
