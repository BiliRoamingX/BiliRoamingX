...
public final class PremiereText extends GeneratedMessageLite<PremiereText, PremiereText.b> implements MessageLiteOrBuilder {
    ...
    /* compiled from: BL */
    /* loaded from: classes21.dex */
    public static final class b extends GeneratedMessageLite.Builder<PremiereText, b> implements MessageLiteOrBuilder {
        /* synthetic */ b(a aVar) {
            this();
        }

        public b clearGuidanceEntry() {
            copyOnWrite();
            ((PremiereText) this.instance).clearGuidanceEntry();
            return this;
        }

        public b clearGuidancePulldown() {
            copyOnWrite();
            ((PremiereText) this.instance).clearGuidancePulldown();
            return this;
        }

        public b clearIntroIcon() {
            copyOnWrite();
            ((PremiereText) this.instance).clearIntroIcon();
            return this;
        }

        public b clearIntroIconNight() {
            copyOnWrite();
            ((PremiereText) this.instance).clearIntroIconNight();
            return this;
        }

        public b clearIntroTitle() {
            copyOnWrite();
            ((PremiereText) this.instance).clearIntroTitle();
            return this;
        }

        public b clearOnlineIcon() {
            copyOnWrite();
            ((PremiereText) this.instance).clearOnlineIcon();
            return this;
        }

        public b clearOnlineIconDark() {
            copyOnWrite();
            ((PremiereText) this.instance).clearOnlineIconDark();
            return this;
        }

        public b clearOnlineText() {
            copyOnWrite();
    ...
    public static b newBuilder(PremiereText premiereText) {
