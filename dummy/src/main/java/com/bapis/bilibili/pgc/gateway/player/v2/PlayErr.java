...
public enum PlayErr implements Internal.EnumLite {
    ...
    private static final Internal.EnumLiteMap<PlayErr> internalValueMap = new Internal.EnumLiteMap<PlayErr>() { // from class: com.bapis.bilibili.pgc.gateway.player.v2.PlayErr.1
