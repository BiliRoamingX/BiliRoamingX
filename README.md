...
- 直接在 [GitHub Release](https://github.com/zjns/BiliRoamingX-integrations/releases) 下载
- 参照 [revanced-cli](https://github.com/ReVanced/revanced-cli/tree/main/docs) 文档打包

## 📃 Licence

[![GitHub](https://img.shields.io/github/license/zjns/BiliRoamingX-integrations?style=for-the-badge)](https://github.com/zjns/BiliRoamingX-integrations/blob/main/LICENSE)
